...
const ApplePayShippingContact = require('./common/applepay/ApplePayShippingContact');
const ApplePayBillingContact = require('./common/applepay/ApplePayBillingContact');
const ApplePayToken = require('./common/applepay/ApplePayToken');
