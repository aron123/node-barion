...
Barion.prototype.startPaymentWithGoogleToken = function (options, callback) {
    return doRequestAndReturn({
        defaults: this.defaults,
        customs: options,
        schema: StartPaymentWithGoogleToken,
        service: services.startPaymentWithGoogleToken
    }, callback);
};
 ...
 * @param {Function} [callback] - Callback that handles the response. If not passed, the function returns a *Promise*.
 * @see {@link https://docs.barion.com/ApplePay-StartPaymentWithAppleToken|Barion API: Start Payment With Apple token}
 */
 ...
 * @param {Function} [callback] - Callback that handles the response. If not passed, the function returns a *Promise*.
 * @see {@link https://docs.barion.com/UserHistory-GetHistory-v3|Barion API: transaction history}
 */
Barion.prototype.getHistory = function (options, callback) {
    return doRequestAndReturn({
        defaults: this.defaults,
        customs: options,
        schema: GetHistory,
        service: services.getHistory
    }, callback);
};
