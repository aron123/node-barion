 ...
 * @param {Object} options - Options that are required to download statement.
 * @param {Function} [callback] - Callback that handles the response. If not passed, the function returns a *Promise*.
 * @see {@link https://docs.barion.com/Payment-StartPaymentWithGoogleToken-v3|Barion API Documentation}
 */
Barion.prototype.googlePay = function (options, callback) {
    return doRequestAndReturn({
        defaults: this.defaults,
        customs: options,
        schema: GooglePay,
        service: services.googlePay
    }, callback);
};
