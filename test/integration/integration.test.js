...
describe('Integration tests', function () {
    ...
    describe('Get accounts with API key (callback)', function () {
        it('should query accounts with API key when validation is turned on', function (done) {
            validatedBarion.getAccounts(testData.getAccounts.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.deep.include(testData.getAccounts.successResponseBody);
                done();
            });
        ...
        it('should query accounts with API key when validation is turned off', function (done) {
            notValidatedBarion.getAccounts(testData.getAccounts.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.deep.include(testData.getAccounts.successResponseBody);
                done();
            });
    ...
    describe('Get accounts with API key (Promise)', function () {
        it('should query accounts with API key when validation is turned on', function (done) {
            validatedBarion.getAccounts(testData.getAccounts.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.deep.include(testData.getAccounts.successResponseBody);
                    done();
                });
        ...
        it('should query accounts with API key when validation is turned off', function (done) {
            notValidatedBarion.getAccounts(testData.getAccounts.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.deep.include(testData.getAccounts.successResponseBody);
                    done();
                });
    ...
    describe('Bank transfer with API key (callback)', function () {
        it('should send bank transfer with API key when validation is turned on', function (done) {
            validatedBarion.bankTransfer(testData.bankTransfer.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.deep.include(testData.bankTransfer.successResponseBody);
                done();
            });
        ...
        it('should send bank transfer with API key when validation is turned off', function (done) {
            notValidatedBarion.bankTransfer(testData.bankTransfer.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.deep.include(testData.bankTransfer.successResponseBody);
                done();
            });
    ...
    describe('Bank transfer with API key (Promise)', function () {
        it('should send bank transfer with API key when validation is turned on', function (done) {
            validatedBarion.bankTransfer(testData.bankTransfer.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.deep.include(testData.bankTransfer.successResponseBody);
                    done();
                });
        ...
        it('should send bank transfer with API key when validation is turned off', function (done) {
            notValidatedBarion.bankTransfer(testData.bankTransfer.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.deep.include(testData.bankTransfer.successResponseBody);
                    done();
                });
    ...
    describe('Email transfer with API key (callback)', function () {
        it('should start email transfer with API key when validation is turned on', function (done) {
            validatedBarion.emailTransfer(testData.emailTransfer.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.deep.include(testData.emailTransfer.successResponseBody);
                done();
            });
        ...
        it('should start email transfer with API key when validation is turned off', function (done) {
            notValidatedBarion.emailTransfer(testData.emailTransfer.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.deep.include(testData.emailTransfer.successResponseBody);
                done();
            });
    ...
    describe('Email transfer with API key (Promise)', function () {
        it('should start email transfer with API key when validation is turned on', function (done) {
            validatedBarion.emailTransfer(testData.emailTransfer.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.deep.include(testData.emailTransfer.successResponseBody);
                    done();
                });
        ...
        it('should start email transfer with API key when validation is turned off', function (done) {
            notValidatedBarion.emailTransfer(testData.emailTransfer.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.deep.include(testData.emailTransfer.successResponseBody);
                    done();
                });
    ...
    describe('Download statement with API key (callback)', function () {
        it('should download monthly statement with API key when validation is turned on', function (done) {
            validatedBarion.downloadStatement(testData.downloadStatement.successRequestBodyWithApiKey, (err, res) => {
                expect(err).to.be.null;
                expect(res).to.be.an('object');
                expect(res.Buffer).to.be.instanceOf(Buffer);
                expect(res.Buffer.length).to.be.greaterThan(0);
        ...
        it('should download monthly statement with API key when validation is turned off', function (done) {
            notValidatedBarion.downloadStatement(
                testData.downloadStatement.successRequestBodyWithApiKey, (err, res) => {
                    expect(err).to.be.null;
                    expect(res).to.be.an('object');
                    expect(res.Buffer).to.be.instanceOf(Buffer);
                    expect(res.Buffer.length).to.be.greaterThan(0);
    ...
    describe('Download statement with API key (Promise)', function () {
        it('should download monthly statement with API key when validation is turned on', function (done) {
            validatedBarion.downloadStatement(testData.downloadStatement.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.be.an('object');
                    expect(res.Buffer).to.be.instanceOf(Buffer);
                    expect(res.Buffer.length).to.be.greaterThan(0);
        ...
        it('should download monthly statement with API key when validation is turned off', function (done) {
            notValidatedBarion.downloadStatement(testData.downloadStatement.successRequestBodyWithApiKey)
                .then(res => {
                    expect(res).to.be.an('object');
                    expect(res.Buffer).to.be.instanceOf(Buffer);
                    expect(res.Buffer.length).to.be.greaterThan(0);
